...
// Usage: groovy install-0_4.groovy
...
def powertacModules =
  ["powertac": ["powertac-demo-agent-grails": "release-0.4",
   ...
   "powertac-plugins": ["powertac-accounting-service": "release-0.4",
                        "powertac-auctioneer-pda": "release-0.4",
                        "powertac-common": "release-0.4", 
                        "powertac-db-stuff": "release-0.3", 
                        "powertac-default-broker": "release-0.3",
                        "powertac-distribution-utility": "release-0.4", 
                        "powertac-genco": "release-0.4",
                        "powertac-household-customer": "release-0.4", 
                        "powertac-physical-environment": "release-0.4",
                        "powertac-random": "release-0.3", 
                        "powertac-server-interface": "release-0.4", 
                        "powertac-style": "release-0.3",
                        "powertac-visualizer": "release-0.4", 
